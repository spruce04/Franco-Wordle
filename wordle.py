#Francordle game. to play the game, you must also download the 5LetterWords.txt file from https://github.com/spruce04/Franco-Wordle
...
try : 
    ...
    print('5LetterWords.txt could not be found. Please ensure that you have downloaded and properly names the file from github, and that it is placed in the same folder as wordle.py')
    quit()
...
GuessCount = 6
PlayerGuess = '?????'
ChosenNumber = random.randint(0,16)
...
BackgroundSetup()
greeting = Label(text = "Welcome to Francordle.")
...
CreditDue = Label(root, text = "Programmed by Sam Flax")
